...
<div class="Mentions-légales">
    ...
    <div class="wrap">
        <p>En vertu de l'article 6 de la loi n° 2004-575 du 21 juin 2004 pour la confiance dans l'économie numérique, il
            est précisé aux utilisateurs du site <a href="http://N'FactoryStats/">N'FactoryStats</a> l'identité des
    ...
    <div class="wrap">
        <p>L’utilisation du site <a href="http://N'FactoryStats/">N'FactoryStats</a> implique l’acceptation pleine et
            ...
            susceptibles d’être modifiées ou complétées à tout moment, les utilisateurs du site <a
                    href="http://N'FactoryStats/">N'FactoryStats</a> sont donc invités à les consulter de manière
            régulière.</p>
        <p>Ce site est normalement accessible à tout moment aux utilisateurs. Une interruption pour raison de
            maintenance technique peut être toutefois décidée par N'FactorySchool, qui s’efforcera alors de communiquer
            préalablement aux utilisateurs les dates et heures de l’intervention.</p>
        <p>Le site <a href="http://N'FactoryStats/">N'FactoryStats</a> est mis à jour régulièrement par Michel. De la
    ...
    <div class="wrap">
        <p>Le site <a href="http://N'FactoryStats/">N'FactoryStats</a> a pour objet de fournir une information
            concernant l’ensemble des activités de la société.</p>
        <p>N'FactorySchool s’efforce de fournir sur le site <a href="http://N'FactoryStats/">N'FactoryStats</a> des
        ...
        <p>Tous les informations indiquées sur le site <a href="http://N'FactoryStats/">N'FactoryStats</a> sont données
            à titre indicatif, et sont susceptibles d’évoluer. Par ailleurs, les renseignements figurant sur le site <a
                    href="http://N'FactoryStats/">N'FactoryStats</a> ne sont pas exhaustifs. Ils sont donnés sous
    ...
    <div class="wrap">
        <p>En France, les données personnelles sont notamment protégées par la loi n° 78-87 du 6 janvier 1978, la loi n°
            ...
            1995.</p>
        <p>A l'occasion de l'utilisation du site <a href="http://N'FactoryStats/">N'FactoryStats</a>, peuvent êtres
            recueillies : l'URL des liens par l'intermédiaire desquels l'utilisateur a accédé au site <a
                    href="http://N'FactoryStats/">N'FactoryStats</a>, le fournisseur d'accès de l'utilisateur, l'adresse
        ...
        <p> En tout état de cause N'FactorySchool ne collecte des informations personnelles relatives à l'utilisateur
            que pour le besoin de certains services proposés par le site <a
                    href="http://N'FactoryStats/">N'FactoryStats</a>. L'utilisateur fournit ces informations en toute
            connaissance de cause, notamment lorsqu'il procède par lui-même à leur saisie. Il est alors précisé à
            l'utilisateur du site <a href="http://N'FactoryStats/">N'FactoryStats</a> l’obligation ou non de fournir ces
            informations.</p>
        ...
        <p>Aucune information personnelle de l'utilisateur du site <a href="http://N'FactoryStats/">N'FactoryStats</a>
            ...
            et de modification des données vis à vis de l'utilisateur du site <a href="http://N'FactoryStats/">N'FactoryStats</a>.
        </p>
    ...
    <div class="wrap">
        <p>Le site <a href="http://N'FactoryStats/">N'FactoryStats</a> contient un certain nombre de liens hypertextes
        ...
        <p>La navigation sur le site <a href="http://N'FactoryStats/">N'FactoryStats</a> est susceptible de provoquer
    ...
    <div class="wrap">
        <p>Tout litige en relation avec l’utilisation du site <a href="http://N'FactoryStats/">N'FactoryStats</a> est
